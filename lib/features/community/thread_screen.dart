              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    Text(
                      post.title,
                      style: PgText.poppins(19, FontWeight.w700, color: c.text),
                    ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      Post.timeAgo(comment.createdAt),
                      style: PgText.inter(11, FontWeight.w400, color: c.faint),
                    ),
                    if (!isMine) ...[
                      const Spacer(),
                      GestureDetector(
