                ...
                children: [
                  GridView.count(
                    ...
                    children: [
                      _QuickAction(
                        emoji: '🐾',
                        title: 'Discover',
                        subtitle: 'Swipe & Woof nearby pets',
                        bg: null,
                        gradient: [c.brand2, const Color(0xFFF8B45E)],
                        fg: Colors.white,
                      ...
                      _QuickAction(
                        emoji: '🦮',
                        title: 'Services',
                        subtitle: 'Walkers, sitters, groomers',
                        bg: c.butter,
                        fg: c.text,
                      ...
                      _QuickAction(
                        emoji: '🏡',
                        title: 'Homestay',
                        subtitle: 'Verified boarding hosts',
                        bg: c.lav,
                        fg: c.text,
                        onTap: () => context.push(Routes.homestay),
                      ),
                      _QuickAction(
                        emoji: '💬',
                        title: 'Community',
                        subtitle: 'Ask, share, lost & found',
                        bg: c.mint,
                        fg: c.text,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Pets near you',
                        style: PgText.sectionHeader(context),
                      ),
                      GestureDetector(
                            ...
                            children: [
                              for (final p in pets) ...[
                                PetRow(
                                  ...
                                  onWoof: () {},
                                  onTap: () =>
                                      context.push(Routes.petProfile, extra: p),
                                ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '"Best vet in Bandra for vaccinations?"',
                          style: PgText.poppins(
                            15,
                            FontWeight.w600,
                            color: c.text,
                        ...
                        Text(
                          '24 replies · posted by @dachshund_dad',
                          style: PgText.inter(
                            12.5,
                            FontWeight.w400,
                            color: c.muted,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Check back soon — new pets join every day.',
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Text(
                  title,
                  style: PgText.poppins(15, FontWeight.w700, color: fg),
                ),
                Text(
                  subtitle,
                  maxLines: 2,
