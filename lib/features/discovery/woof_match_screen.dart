...
class WoofMatchScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ownerName = (pet?.ownerName ?? '').isNotEmpty
        ? pet!.ownerName
        : 'Pet parent';
    return PgBackScope(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "You and $name's parent both said Woof. Say hi and plan a playdate!",
                    textAlign: TextAlign.center,
                    style: PgText.inter(
                      15,
                      FontWeight.w500,
                  ...
                  SizedBox(
                    width: double.infinity,
                    child: _outlineButton('Keep swiping', () => context.pop()),
                  ),
                ],
              ),
            ),
  ...
  Widget _outlineButton(String label, VoidCallback onTap) => GestureDetector(
    ...
    child: Container(
      ...
      child: Text(
        label,
        style: PgText.poppins(15, FontWeight.w700, color: Colors.white),
      ),
    ),
  );
}
